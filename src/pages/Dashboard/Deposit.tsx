...
export default function Deposit() {
	...
	return (
		<div className="max-w-2xl mx-auto">
			{!success ? (
				<div className="bg-white/80 dark:bg-gray-900/20 backdrop-blur-sm rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
					<div className="p-8">
						{/* Header */}
						<div className="w-full flex items-center gap-4 mb-8">
							<div className="w-10 h-10 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/50 dark:to-blue-900/30 rounded-3xl flex items-center justify-center shadow-inner">
								<Wallet className="w-5 h-5 text-blue-600 dark:text-blue-400" />
							</div>
							<h1 className="text-lg sm:text-2xl font-medium text-gray-900 dark:text-gray-100">
								Make a{" "}
				...
				<div className="bg-white/80 dark:bg-gray-900/20 backdrop-blur-sm rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
					<div className="p-8">
						...
						<div className="text-center mb-8">
							...
							<h1 className="text-2xl font-medium tracking-wide text-gray-900 dark:text-gray-100 mb-2">
								Deposit{" "}
						...
						<div className="space-y-4">
							...
							<div className="flex gap-3 p-4 bg-red-50 dark:bg-red-950/30 rounded-2xl">
								...
								<p className="text-sm text-red-800 dark:text-red-200 leading-relaxed">
									<strong>Important:</strong> Please ensure you are sending to the correct wallet address and
									network. Sending to the wrong address or network may result in permanent loss of funds.
								</p>
							</div>
						</div>
					</div>
