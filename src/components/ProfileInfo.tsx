...
const updateProfile = async (data: globalThis.FormData, userId: string): Promise<void> => {
	try {
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
				...
				<div className="lg:col-span-1">
					<div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
						<div className="w-full h-72 bg-gray-200 dark:bg-gray-700 rounded-xl mb-4 flex items-center justify-center overflow-hidden">
