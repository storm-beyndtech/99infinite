	...
	return (
		<div className="grid grid-cols-3 max-lg:grid-cols-1 gap-4 mb-4">
			<div className="flex flex-col gap-2 p-3 rounded-lg bg-white dark:border-gray-900 border-gray-200 dark:bg-gray-950/70 border shadow-lg">
				...
				<p className="text-xs font-light flex text-gray-600 dark:text-gray-300">All Users</p>
			</div>
			...
			<div className="flex flex-col gap-2 p-3 rounded-lg bg-white dark:border-gray-900 border-gray-200 dark:bg-gray-950/70 border shadow-lg">
				...
				<p className="text-xs font-light flex text-gray-600 dark:text-gray-300">Banned Users</p>
			</div>
			...
			<div className="flex flex-col gap-2 p-3 rounded-lg bg-white dark:border-gray-900 border-gray-200 dark:bg-gray-950/70 border shadow-lg">
				...
				<p className="text-xs font-light flex text-gray-600 dark:text-gray-300">Active Users</p>
			</div>
		</div>
	);
}
