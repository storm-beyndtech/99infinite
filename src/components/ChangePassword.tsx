...
export default function ChangePassword() {
	...
	return (
		<div className="min-w-96 w-fit mx-auto bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 p-4">
			<h2 className="text-xl font-semibold dark:text-white text-gray-800 mb-6">Change Password</h2>
