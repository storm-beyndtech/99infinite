...
const WithdrawalForm: React.FC<WithdrawalFormProps> = ({ isOpen, onClose, userBalance, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl border border-white/30 dark:border-slate-700/30 rounded-3xl max-w-md w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="relative z-10 p-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-amber-100 to-yellow-100 dark:from-amber-950/50 dark:to-yellow-900/30 rounded-2xl flex items-center justify-center">
            ...
            <button
              onClick={onClose}
              className="w-10 h-10 rounded-xl bg-gray-100 dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 flex items-center justify-center transition-colors"
            >
          ...
          {formData.autoWithdraw && (
            <div className="bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-950/30 dark:to-green-950/30 rounded-2xl p-4 mb-6 border border-emerald-200/50 dark:border-emerald-800/50">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-emerald-800 dark:text-emerald-300 mb-1">Auto-Withdrawal Enabled</h3>
                  <p className="text-sm text-emerald-700 dark:text-emerald-400">
                    Your withdrawal will be processed automatically if funds are available in our Bybit wallet.
                  </p>
                </div>
              </div>
            </div>
