...
import type { ContractPlan } from '../../types/contract';

interface GoldContractCardProps {
  plan: ContractPlan;
  onSelect: (planId: string) => void;
  isPopular?: boolean;
}

const GoldContractCard: React.FC<GoldContractCardProps> = ({ plan, onSelect, isPopular = false }) => {
        ...
        <div className="bg-gradient-to-r from-gray-50/80 to-white/80 dark:from-slate-800/50 dark:to-slate-700/50 rounded-2xl p-6 mb-8">
          <div className="text-center">
            <div className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
              {formatCurrency(plan.minContract)} - {formatCurrency(plan.maxContract)}
            </div>
...
export default GoldContractCard;