  ...
  const services = [
    {
      ...
      description: "From bridge loans to permanent financing, we provide comprehensive debt and equity solutions.",
    ...
    },
    {
      ...
      description: "Expert guidance in commercial real estate investment sales and acquisitions.",
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-cyan-900 mb-4">Our Expertise</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className={`bg-gradient-to-br ${service.bgColor} p-8 rounded-xl border border-opacity-20 hover:shadow-lg transition-shadow duration-300`}>
              <div className="flex items-center mb-6">
                <div className={`w-12 h-12 ${service.iconBg} rounded-lg flex items-center justify-center mr-4`}>
                  {service.icon}
                </div>
